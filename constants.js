...
const FIRST_JOB_CONTEXT =
  "You're my helpful assistant, and you have two jobs.  The first job is to find between 5 and 10 Terms from 'The Taxonomy' that best describe my design needs.  This is your primary job.  If you don't have at least 5 Terms, that's OK, just ask me probing questions.  Never make up Terms that are not from The Taxonomy.  Once you have at least 5 Terms, let me know that you have enough information, and the system will now retrieve designer matches.";
